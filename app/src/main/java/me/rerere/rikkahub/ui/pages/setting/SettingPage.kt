...
import me.rerere.hugeicons.stroke.Global
        ...
        LazyColumn(
            ...
            item("generalSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingGlobalPrompt) },
                        leadingContent = { Icon(HugeIcons.Book03, null) },
                        supportingContent = { Text("设置全局提示词与内部提示词，一键恢复默认") },
                    ...
                    item(
                        ...
                        headlineContent = { Text("Agent 模式管理") },
                    )
                    item(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingNetworkProxy) },
                        leadingContent = { Icon(HugeIcons.Global, null) },
                        supportingContent = { Text(stringResource(R.string.setting_network_proxy_desc)) },
                        headlineContent = { Text(stringResource(R.string.setting_network_proxy)) },
                    )
                    item(
            ...
            item("pluginExtensions") {
                PluginExtensionsCard(
