...
private fun TavernMarketTab(
    entries: List<me.rerere.rikkahub.data.api.TavernListing>,
    loading: Boolean,
    error: String?,
    downloadingId: String?,
    ...
    search: String,
    onSearchChange: (String) -> Unit,
    onInstall: (me.rerere.rikkahub.data.api.TavernListing) -> Unit,
    onRetry: () -> Unit,
    onRefresh: () -> Unit,
...
@Composable
private fun TavernEntryCard(
    entry: me.rerere.rikkahub.data.api.TavernListing,
    installed: Boolean,
    downloading: Boolean,
    onInstall: () -> Unit,
) {
